...
function ImagenesCarruselContent() {
      ...
      <div className="clase-completa-container">
        <section className="clase-hero" data-aos="fade-down">
          ...
          <p className="clase-subtitulo">
            Esta clase es solo para alumnos de 4º y 5º grado.
          </p>
        </section>
  ...
  return (
    <div className="clase-completa-container">
      ...
      <section className="clase-hero" data-aos="fade-down">
        ...
        <p className="clase-subtitulo">
          Aprendé a crear un carrusel de imágenes con HTML y CSS, y descargá el
          paquete de imágenes de práctica
        </p>
      </section>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <p>
          Vamos a construir un <strong>carrusel de imágenes</strong> con HTML y
          CSS puro, sin JavaScript. También vas a poder{" "}
          <strong>descargar un paquete de imágenes</strong> para practicar.
        </p>
      </section>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <ol>
          ...
          <li>
            Descomprimí el archivo <code>imagenes-carrusel.rar</code> en una
            carpeta de tu PC.
          </li>
          <li>
            Seguí la guía paso a paso para crear tu carrusel con HTML y CSS.
          </li>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <div className="componente" style={{ textAlign: "center" }}>
          <p>
            Hacé clic en el botón para descargar el archivo{" "}
            <strong>imagenes-carrusel.rar</strong>
          </p>
          <a
            href="/image/imagenes-carrusel.rar"
            download
            className="clase-btn"
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <ul>
          ...
          <li>1 carpeta <code>image</code> con las imágenes que se usarán.</li>
        </ul>
      </section>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <p className="conclusion">
          ✅ Creá tu propio carrusel con HTML y CSS usando las imágenes que
          descargaste.
          <br />✅ Subí tu trabajo a Google Drive y compartí el enlace con tu
          profesor.
        </p>
      </section>
