  ...
  return (
    <div className="clase-completa-container">
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        <h2>1. ¿Qué es HTML?</h2>
        <p>
          HTML significa <strong>HyperText Markup Language</strong> (Lenguaje de
          Marcado de Hipertexto).
        </p>
        <ul>
          <li>Es el lenguaje básico para crear páginas web.</li>
          <li>
            Sirve para estructurar el contenido (textos, imágenes, enlaces,
            tablas, etc.).
          </li>
          <li className="tip">
...
<body>
  ...
  <p>Esta es mi primera página en HTML.</p>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <ul>
          <li>
            <code>&lt;!DOCTYPE html&gt;</code> → Indica que el documento es
            HTML5.
          </li>
          <li>
            <code>&lt;html&gt;...&lt;/html&gt;</code> → Contiene todo el
            documento.
          </li>
          <li>
            <code>&lt;head&gt;...&lt;/head&gt;</code> → Información de la página
            (no visible).
          </li>
          <li>
            <code>&lt;body&gt;...&lt;/body&gt;</code> → Todo lo que se ve en la
            página.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <code>&lt;h1&gt;</code> a <code>&lt;h6&gt;</code> → Títulos (h1 =
            más grande).
          </li>
          <li>
            <code>&lt;p&gt;</code> → Párrafo.
          ...
          <li>
            <code>&lt;strong&gt;</code> o <code>&lt;b&gt;</code> → Negrita.
          </li>
          <li>
            <code>&lt;em&gt;</code> o <code>&lt;i&gt;</code> → Cursiva.
          </li>
          <li>
            <code>&lt;u&gt;</code> → Subrayado.
          </li>
          <li>
            <code>&lt;mark&gt;</code> → Resaltado.
          </li>
          <li>
            <code>&lt;small&gt;</code> → Texto pequeño.
          </li>
          <li>
            <code>&lt;sup&gt;</code> y <code>&lt;sub&gt;</code> → Superíndice y
            subíndice.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <code>&lt;ul&gt;</code> → Lista desordenada (viñetas).
          </li>
          <li>
            <code>&lt;ol&gt;</code> → Lista ordenada (números).
          </li>
          <li>
            <code>&lt;li&gt;</code> → Elemento de la lista.
          </li>
        </ul>
        <div className="componente">
  ...
  <li>Argentina</li>
        ...
        <ul>
          <li>
            <code>&lt;a href="url"&gt;</code> → Enlace.
          </li>
          <li>
            <code>&lt;img src="imagen.jpg" alt="texto"&gt;</code> → Imagen.
          </li>
        </ul>
  ...
  <tr>
    ...
    <td>16</td>
        ...
        <ul>
          ...
          <li>
            <code>&lt;select&gt;</code> y <code>&lt;option&gt;</code> → Lista
            desplegable.
          </li>
          <li>
            <code>&lt;button&gt;</code> → Botón.
          </li>
        </ul>
        <div className="componente">
          <strong>Ejemplo:</strong>
  ...
  <button type="submit">Enviar</button>
        ...
        <ul>
          <li>
            <code>&lt;audio controls&gt;</code> → Audio.
          </li>
          <li>
            <code>&lt;video controls&gt;</code> → Video.
          </li>
          <li>
            <code>&lt;iframe&gt;</code> → Insertar otra página o video de
            YouTube.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <code>&lt;nav&gt;</code> → Menú de navegación.
          </li>
          <li>
            <code>&lt;header&gt;</code> → Encabezado de página.
          </li>
          <li>
            <code>&lt;footer&gt;</code> → Pie de página.
          </li>
          <li>
            <code>&lt;section&gt;</code> → Sección de contenido.
          </li>
          <li>
            <code>&lt;article&gt;</code> → Artículo.
          </li>
          <li>
            <code>&lt;aside&gt;</code> → Barra lateral.
          </li>
        </ul>
      </section>
      ...
      <section className="clase-seccion cuadro-rebote" data-aos="fade-up">
        ...
        <p className="conclusion">
          ...
          <br />
          Estructura básica: <code>&lt;!DOCTYPE html&gt;</code>,{" "}
          <code>&lt;html&gt;</code>, <code>&lt;head&gt;</code>,{" "}
          <code>&lt;body&gt;</code>.
          <br />
          Las etiquetas van entre <code>&lt; &gt;</code>.
          <br />
